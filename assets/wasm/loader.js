      ...
      d = (function () {
        ...
        return function (a) {
          ...
          function Xe(e, t, n, r, o, a) {
            ...
            var b = jt(a),
              v =
                self.WhatsAppVoipWasmWorkerCompatibleCallbacks.cryptoHkdfExtractWithSaltAndExpand(
                  { key_: f, salt_: g, info_: b, length: m },
                ),
              S = new Uint8Array(v),
              R = Ni(m);
            return (ri(S, R), R);
          ...
          function Ye(e, t, n, r, o) {
            ...
            h.set(f);
            var y =
                self.WhatsAppVoipWasmWorkerCompatibleCallbacks.hmacSha256KeyGenerator(
                  { data_: _, key_: h },
                ),
              C = new Uint8Array(y),
              b = Ni(c);
          ...
          function Je(e) {
            var t = jt(e);
            return window.WhatsAppVoipWasmWorkerCompatibleCallbacks.isParticipantKnownContact(
              { jid: t },
            );
          }
          ...
          var xt = function () {
            ...
            $t = {
              ...
              register: function (t, n) {
                (($t.ttys[t] = { input: [], output: [], ops: n }),
                  zt.registerDevice(t, $t.stream_ops));
              },
              stream_ops: {
                open: function (t) {
            ...
            Mt = {
                  ...
                  zt.isDir(e.mode)
                    ...
                    : zt.isFile(e.mode)
                      ? ((e.node_ops = Mt.ops_table.file.node),
                        ...
                        (e.contents = null))
                      : zt.isLink(e.mode)
                        ? ((e.node_ops = Mt.ops_table.link.node),
                          (e.stream_ops = Mt.ops_table.link.stream))
                        : zt.isChrdev(e.mode) &&
                          ((e.node_ops = Mt.ops_table.chrdev.node),
                          (e.stream_ops = Mt.ops_table.chrdev.stream)),
              ...
              node_ops: {
                ...
                rename: function (t, n, r) {
                  if (zt.isDir(t.mode)) {
                    ...
                    if (e)
                      for (var o in e.contents) throw new zt.ErrnoError(55);
                  }
              ...
              stream_ops: {
                ...
                allocate: function (t, n, r) {
                  (Mt.expandFileStorage(t.node, n + r),
              ...
              reconcile: function (t, n, r) {
                ...
                ((u.onerror = function (e) {
                  ...
                  a
                    ...
                    .forEach(function (e) {
                      n.type === "local"
                        ? qt.removeLocalEntry(e, d)
                        : qt.removeRemoteEntry(c, e, d);
                    }));
              },
            },
            Ut = {
          ...
          var zt = {
              ...
              lookupPath: function (t, n) {
                if ((n === void 0 && (n = {}), (t = Rt.resolve(t)), !t))
              ...
              rename: function (t, n) {
                ...
                if (((c = Rt.relative(n, e)), c.charAt(0) !== "."))
              ...
              createStandardStreams: function () {
                (y.stdin
                  ? zt.createDevice("/dev", "stdin", y.stdin)
                  : zt.symlink("/dev/tty", "/dev/stdin"),
                  y.stdout
                    ? zt.createDevice("/dev", "stdout", null, y.stdout)
                    : zt.symlink("/dev/tty", "/dev/stdout"),
                  y.stderr
                    ? zt.createDevice("/dev", "stderr", null, y.stderr)
              ...
              doStat: function (t, n, r) {
                try {
                  ...
                  if (
                    e &&
                    e.node &&
                    bt.normalize(n) !== bt.normalize(zt.getPath(e.node))
                  )
                    return -54;
                  throw e;
                }
          ...
          function Qt(e) {
            ...
            ((H = e),
              me() ||
                (en.terminateAllThreads(), y.onExit && y.onExit(e), (V = !0)),
              L(e, new pt(e)));
          }
          var Xt = function (t, n) {
            ...
            en = {
                  ...
                  (o.addMessageListener("cmd", function (e) {
                    ...
                    (o.onerror = function (e) {
                      ...
                      throw (
                        o.pthread_ptr &&
                          (t =
                            "Pthread " + Jt(o.pthread_ptr) + " sent an error!"),
                        F(
                          t +
                            " " +
                            e.filename +
              ...
              loadWasmModuleToAllWorkers: function (t) {
                ...
                var e = (u || (u = n("Promise"))).all(
                  en.unusedWorkers.map(en.loadWasmModuleToWorker),
                );
                e.then(t);
              },
          ...
          function fn() {
            (F("missing function: _ZN6webrtc18EncodedImageBuffer6CreateEm"),
              ke(-1));
          }
          ...
          function br() {
            var e = [];
            for (var t in kr)
              Object.prototype.hasOwnProperty.call(kr, t) && e.push(kr[t]);
            return e;
          }
          var vr = [];
          function Sr() {
          ...
          function Ir(e, t) {
            for (
              t === void 0 && er("ptr should not be undefined");
              e.baseClass;
            )
          ...
          function Dr(e, t) {
            (!t.ptrType || !t.ptr) &&
              nr("makeClassHandle requires ptr and ptrType");
          ...
          function xr(e) {
            ...
            return s === null
              ? o.call(this)
              : this.isSmartPointer
                ? Dr(l.registeredClass.instancePrototype, {
                    ptrType: l,
                    ptr: s,
                    smartPtrType: this,
                    smartPtr: e,
                  ...
                  if (n) {
                    ...
                    ((r.leakWarning = new Error(
                      ...
                      "captureStackTrace" in Error &&
                        Error.captureStackTrace(r.leakWarning, xr),
                      pr.register(t, r, t));
                  }
                  return t;
                }),
          ...
          function jr(e, t) {
            ...
            if (
              ((n = Gr(t.$$.ptr, r, this.registeredClass)), this.isSmartPointer)
            )
              switch (
                (t.$$.smartPtr === void 0 &&
                  er("Passing raw pointer to smart pointer is illegal"),
                this.sharingPolicy)
              ) {
                case 0:
                  t.$$.smartPtrType === this
          ...
          function to(e, t, n) {
            (Object.prototype.hasOwnProperty.call(y, e) ||
              nr("Replacing nonexistant public symbol"),
          ...
          function no(e, t) {
            ...
            return (
              typeof r != "function" &&
                er("unknown function pointer with signature " + e + ": " + t),
              r
            );
          }
          function ro(e, t) {
              ...
              rr([e, t, n], r ? [r] : [], function (t) {
                ...
                var i = qr(p, function () {
                    if (Object.getPrototypeOf(this) !== s)
                      throw new Zn("Use 'new' to construct " + c);
                    if (d.constructor_body === void 0)
                      throw new Zn(c + " has no accessible constructor");
                ...
                return (
                  (yr[e] = { pointerType: f, constPointerType: g }),
                  to(p, i),
                  [_, f, g]
                );
              }));
          ...
          function yo() {
            for (var e = 0, t = go.reserved; t < go.allocated.length; ++t)
              go.allocated[t] !== void 0 && ++e;
            return e;
          }
          function Co() {
            (go.allocated.push(
          ...
          var bo = {
            toValue: function (t) {
              return (
                t || er("Cannot use deleted val. handle = " + t),
                go.get(t).value
              );
            },
            toHandle: function (t) {
              ...
              (n === 2
                ...
                ar(t, {
                  ...
                  toWireType: function (t, a) {
                    typeof a != "string" &&
                      er("Cannot pass non-string to C++ string type " + r);
                    var e = i(a),
                      s = Ni(4 + e + n);
                    return (
                      (f()[s >> 2] = e >> l),
          ...
          function pa(e, t) {
            if (
              ((ga.mainLoop.timingMode = e),
              (ga.mainLoop.timingValue = t),
              !ga.mainLoop.func)
            )
              return (
                F(
            ...
            if (
              (ga.mainLoop.running || (ca(), (ga.mainLoop.running = !0)),
              e == 0)
            )
            ...
            if (
              ...
              (ga.mainLoop.runner = function () {
                if (!V) {
                  if (ga.mainLoop.queue.length > 0) {
                    ...
                    if ((n.func(n.arg), ga.mainLoop.remainingBlockers)) {
                      ...
                      n.counted
                        ...
                        : ((o = o + 0.5),
                          (ga.mainLoop.remainingBlockers = (8 * r + o) / 9));
                    }
                    if (
                      (A(
                        'main loop blocker "' +
                  ...
                  if (i()) {
                    if (
                      ((ga.mainLoop.currentFrameNumber =
                        (ga.mainLoop.currentFrameNumber + 1) | 0),
                      ga.mainLoop.timingMode == 1 &&
                        ga.mainLoop.timingValue > 1 &&
                        ga.mainLoop.currentFrameNumber %
                          ga.mainLoop.timingValue !=
                          0)
                    ) {
                      ga.mainLoop.scheduler();
                      return;
                    } else
                      ga.mainLoop.timingMode == 0 &&
                        (ga.mainLoop.tickStartTime = _a());
                    (ga.mainLoop.method === "timeout" &&
                      y.ctx &&
                      (dn(
          ...
          var ga = {
            mainLoop: {
              ...
              resume: function () {
                ...
                var e = ga.mainLoop.timingMode,
                  ...
                  n = ga.mainLoop.func;
                ((ga.mainLoop.func = null),
                  fa(n, 0, !1, ga.mainLoop.arg, !0),
                  pa(e, t),
                  ga.mainLoop.scheduler());
              },
            ...
            requestFullscreen: function (t, n) {
              ((ga.lockPointer = t),
                ...
                typeof ga.resizeCanvas == "undefined" &&
                  (ga.resizeCanvas = !1));
              var e = y.canvas;
              function r() {
                ga.isFullscreen = !1;
                ...
                ((document.fullscreenElement ||
                  ...
                  ? ((e.exitFullscreen = ga.exitFullscreen),
                    ...
                    (ga.isFullscreen = !0),
                    ga.resizeCanvas
                      ? ga.setFullscreenCanvasSize()
                      : ga.updateCanvasDimensions(e))
                  : (t.parentNode.insertBefore(e, t),
                    t.parentNode.removeChild(t),
                    ga.resizeCanvas
                      ? ga.setWindowedCanvasSize()
                      : ga.updateCanvasDimensions(e)),
            ...
            calculateMouseEvent: function (t) {
              if (ga.pointerLock)
                (t.type != "mousemove" && "mozMovementX" in t
                  ...
                  : ((ga.mouseMovementX = ga.getMovementX(t)),
                    (ga.mouseMovementY = ga.getMovementY(t))),
                  typeof SDL != "undefined"
                    ? ((ga.mouseX = SDL.mouseX + ga.mouseMovementX),
                      (ga.mouseY = SDL.mouseY + ga.mouseMovementY))
                    : ((ga.mouseX += ga.mouseMovementX),
                      (ga.mouseY += ga.mouseMovementY)));
              else {
                ...
                if (
                  ...
                  if (t.type === "touchstart")
                    ((ga.lastTouches[i.identifier] = u),
                      (ga.touches[i.identifier] = u));
                  else if (t.type === "touchend" || t.type === "touchmove") {
                    var c = ga.touches[i.identifier];
                    (c || (c = u),
                      (ga.lastTouches[i.identifier] = c),
                      (ga.touches[i.identifier] = u));
                  }
                  return;
                }
            ...
            setCanvasSize: function (t, n, r) {
              var e = y.canvas;
              (ga.updateCanvasDimensions(e, t, n),
                r || ga.updateResizeListeners());
            },
            windowedWidth: 0,
            windowedHeight: 0,
          ...
          var ka = [];
          function Ia(e, t, n, r) {
            ((en.currentProxiedOperationCallerThread = t),
              (n /= 2),
              (ka.length = n));
          ...
          var Ta = function (t) {
            ...
            Ma = function () {
              if (!Ma.strings) {
                ...
                for (var n in Pa)
                  Pa[n] === void 0 ? delete t[n] : (t[n] = Pa[n]);
                var r = [];
                ...
                t.startsWith("::")
                  ...
                  t.indexOf(".") > 0
                    ? ((t = t.replace(new RegExp("[.]", "g"), ":")),
                      (e = t.split(":")),
                      (e[e.length - 4] =
                        Ga(e[e.length - 4]) + Ga(e[e.length - 3]) * 256),
                      (e[e.length - 3] =
                        Ga(e[e.length - 2]) + Ga(e[e.length - 1]) * 256),
            ...
            oi = function (t, n, r, o) {
              ...
              var h = {
                ...
                "%j": function (t) {
                  return m(
                    t.tm_mday +
                      Za(Yo(t.tm_year + 1900) ? ei : ti, t.tm_mon - 1),
                    3,
                  );
                },
                "%m": function (t) {
          ...
          function pi(e, t) {
            if (typeof WebAssembly.Function == "function")
              return new WebAssembly.Function(di(t), e);
            var n = [1];
            mi(t, n);
          ...
          function gi(e) {
            return (
              fi || ((fi = new WeakMap()), _i(0, oe.length)),
              fi.get(e) || 0
            );
          }
          var hi = [];
